...
import { Send, Wallet, CheckCircle, ExternalLink, Bot, User, Loader2, AlertTriangle } from 'lucide-react';
...
export default function ChatPayPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-white">ChatPay</h1>
        <p className="text-zinc-400 text-sm mt-1">Pay with a conversation. Real transactions on-chain.</p>
      </div>
        ...
        <Card className="lg:col-span-2">
          <CardHeader>
            <div className="flex items-center justify-between">
              <div>
                <CardTitle>Payment Conversation</CardTitle>
                <CardDescription>Tell Synq who to pay and why.</CardDescription>
              </div>
              ...
              <div className="flex-1 overflow-y-auto space-y-4 p-4">
                {messages.length === 0 && !pending && !sending && (
                  <div className="flex flex-col items-center justify-center h-full text-center py-12">
                    ...
                    <p className="text-zinc-400 text-sm max-w-md">Tell Synq who to pay and why. Payments are real transactions from your wallet on Sepolia.</p>
                  </div>
                )}
